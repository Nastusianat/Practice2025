    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                ...
                sky = new Bitmap(@"D:\!!!!!!!ПРАКТИКА\Виноградова_день30\Практическая часть30\source\sky.png");	 // небо
                plane = new Bitmap(@"D:\!!!!!!!ПРАКТИКА\Виноградова_день30\Практическая часть30\source\Plane.txt"); // самолет

                // загрузить и задать фоновый рисунок формы
                this.BackgroundImage = new Bitmap(@"D:\!!!!!!!ПРАКТИКА\Виноградова_день30\Практическая часть30\source\sky.png");
            }
