...
namespace EmployeeDataApp
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // helpProvider1
            // 
            this.helpProvider1.HelpNamespace = "D:\\!!!!!!!ПРАКТИКА\\Виноградова_день25\\Практическая часть25\\PR25\\task4\\bin\\Debug\\H" +
    "elp.txt";
            // 
            // button1
            // 
            this.helpProvider1.SetHelpString(this.button1, "For input integer A");
            ...
            this.toolTip1.SetToolTip(this.button1, "here tip");
